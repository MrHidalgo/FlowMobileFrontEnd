...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_task_task__ = __webpack_require__(194);
...
var LoginPage = (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'login-page',template:/*ion-inline-start:"D:\PROJECT\FlowMobile\app\src\pages\login\login.html"*/'<!--<ion-header>-->\n  <!--<ion-navbar>-->\n    <!--<button ion-button menuToggle>-->\n      <!--<ion-icon name="menu"></ion-icon>-->\n    <!--</button>-->\n    <!--<ion-title>Home</ion-title>-->\n  <!--</ion-navbar>-->\n<!--</ion-header>-->\n\n<ion-content>\n\n  <ion-list>\n\n    <ion-item>\n      <ion-input type="text" placeholder="User Email"></ion-input>\n    </ion-item>\n\n    <ion-item>\n      <ion-input type="password" placeholder="Password"></ion-input>\n    </ion-item>\n\n    <button ion-button full>Login</button>\n\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"D:\PROJECT\FlowMobile\app\src\pages\login\login.html"*/
        }),
